...
const Faq = () => {
  ...
  return (
    <div className="mt-25 lg:px-28 md:px-10 bg-white">
      <div className="md:flex md:justify-between md:text-left text-center">
        ...
        <div className="md:mt-0 mt-8 md:space-y-6 space-y-4 md:px-0 px-6">
          {faqs.map((faq, index) => (
            <div key={index} className="border-b border-gray-300 pb-4 xl:w-[550px] lg:w-[440px] md:w-[380px] w-[380px]">
              <div className="flex justify-between items-center">
                <button
                  onClick={() => toggleAnswer(index)}
                  className="w-full text-left md:text-[20px] text-[16px] text-gray-900 py-4 px-6 hover:bg-gray-100
                 transform duration-300 focus:outline-none"
                >
                  {faq.question}
                </button>
